...
data type statistic_data from data.idl.
...
1. Launch Visual Studio in one of two ways:
        - By typing data-x64Win64VS2017.sln in the
          Command Prompt window.
        - By opening Visual Studio on your machine and then opening the
          data-x64Win64VS2017.sln file (in the
...
2. Run C:\Program Files\rti_connext_dds-7.3.0\bin\..\resource\scripts\rtisetenv_x64Win64VS2017.bat
...
> objs\x64Win64VS2017\data_publisher.exe -d <domain_id> -s <sample_count>
> objs\x64Win64VS2017\data_subscriber.exe -d <domain_id> -s <sample_count>
