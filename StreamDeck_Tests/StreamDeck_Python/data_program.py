...
from data_publisher import statistic_dataPublisher
from data_subscriber import statistic_dataSubscriber
...
def main():
    ...
    if args.pub:
        print(f"Running statistic_dataPublisher on domain {args.domain}")
        statistic_dataPublisher.run_publisher(
            domain_id=args.domain,
            sample_count=args.sample_count)
    else:
        print(f"Running statistic_dataSubscriber on domain {args.domain}")
        statistic_dataSubscriber.run_subscriber(
            domain_id=args.domain,
            sample_count=args.sample_count)
