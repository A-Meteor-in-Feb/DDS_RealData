...
This example was generated for architecture x64Win64VS2019, using the
data type control_data from data.idl.
This example builds two applications, named data_publisher and
data_subscriber.
...
1. Launch Visual Studio in one of two ways:
        - By typing data-x64Win64VS2019.sln in the
          Command Prompt window.
        - By opening Visual Studio on your machine and then opening the
          data-x64Win64VS2019.sln file (in the
...
2. Select Build Solution from the Build menu. (You can also right-click
   data_publisher or data_subscriber and
...
To modify the data being sent: edit the data_publisher.cxx
file where it says 
...
1. Right-click data_publisher and choose Debug > Start new instance.
2. Right-click data_subscriber and choose Debug > Start new instance.
...
2. Run C:\Program Files\rti_connext_dds-7.3.0\bin\..\resource\scripts\rtisetenv_x64Win64VS2019.bat
...
> objs\x64Win64VS2019\data_publisher.exe -d <domain_id> -s <sample_count>
> objs\x64Win64VS2019\data_subscriber.exe -d <domain_id> -s <sample_count>
