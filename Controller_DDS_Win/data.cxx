...
control_data::control_data (const std::string& tin_,int32_t lX_,int32_t lY_,int32_t lZ_,int32_t lRx_,int32_t lRy_,int32_t lRz_,uint32_t buttons_,const ::rti::core::bounded_sequence< int32_t, 2L >& rglSlider_):
    m_tin_(tin_), 
    m_lX_(lX_), 
    m_lY_(lY_), 
    m_lZ_(lZ_), 
    ...
    namespace topic {
        ...
        struct native_type_code< ::control_data > {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode control_data_g_tc_rglSlider_sequence;

                static DDS_TypeCode_Member control_data_g_tc_members[9]=
                {
                ...
                control_data_g_tc_rglSlider_sequence = initialize_sequence_typecode< ::rti::core::bounded_sequence< int32_t, 2L > >((2L));

                control_data_g_tc._data._annotations._allowedDataRepresentationMask = 5;

                control_data_g_tc_rglSlider_sequence._data._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
                control_data_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&control_data_g_tc_tin_string;
                control_data_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
                control_data_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
                control_data_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
                control_data_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
                ...
                control_data_g_tc_members[7]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_ulong;
                control_data_g_tc_members[8]._representation._typeCode = (RTICdrTypeCode *)& control_data_g_tc_rglSlider_sequence;
                ...
                control_data_g_tc_members[1]._annotations._defaultValue._d = RTI_XCDR_TK_LONG;
                control_data_g_tc_members[1]._annotations._defaultValue._u.long_value = 0;
                control_data_g_tc_members[1]._annotations._minValue._d = RTI_XCDR_TK_LONG;
                control_data_g_tc_members[1]._annotations._minValue._u.long_value = RTIXCdrLong_MIN;
                control_data_g_tc_members[1]._annotations._maxValue._d = RTI_XCDR_TK_LONG;
                control_data_g_tc_members[1]._annotations._maxValue._u.long_value = RTIXCdrLong_MAX;
                ...
                control_data_g_tc_members[3]._annotations._defaultValue._d = RTI_XCDR_TK_LONG;
                control_data_g_tc_members[3]._annotations._defaultValue._u.long_value = 0;
                control_data_g_tc_members[3]._annotations._minValue._d = RTI_XCDR_TK_LONG;
                control_data_g_tc_members[3]._annotations._minValue._u.long_value = RTIXCdrLong_MIN;
                control_data_g_tc_members[3]._annotations._maxValue._d = RTI_XCDR_TK_LONG;
                control_data_g_tc_members[3]._annotations._maxValue._u.long_value = RTIXCdrLong_MAX;
                control_data_g_tc_members[4]._annotations._defaultValue._d = RTI_XCDR_TK_LONG;
                control_data_g_tc_members[4]._annotations._defaultValue._u.long_value = 0;
                control_data_g_tc_members[4]._annotations._minValue._d = RTI_XCDR_TK_LONG;
                control_data_g_tc_members[4]._annotations._minValue._u.long_value = RTIXCdrLong_MIN;
                control_data_g_tc_members[4]._annotations._maxValue._d = RTI_XCDR_TK_LONG;
                control_data_g_tc_members[4]._annotations._maxValue._u.long_value = RTIXCdrLong_MAX;
                ...
                control_data_g_tc_members[7]._annotations._defaultValue._d = RTI_XCDR_TK_ULONG;
                control_data_g_tc_members[7]._annotations._defaultValue._u.ulong_value = 0u;
                control_data_g_tc_members[7]._annotations._minValue._d = RTI_XCDR_TK_ULONG;
                control_data_g_tc_members[7]._annotations._minValue._u.ulong_value = RTIXCdrUnsignedLong_MIN;
                control_data_g_tc_members[7]._annotations._maxValue._d = RTI_XCDR_TK_ULONG;
                control_data_g_tc_members[7]._annotations._maxValue._u.ulong_value = RTIXCdrUnsignedLong_MAX;
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                static RTIXCdrMemberAccessInfo control_data_g_memberAccessInfos[9] =
                ...
                control_data_g_memberAccessInfos[8].bindingMemberValueOffset[0] = 
