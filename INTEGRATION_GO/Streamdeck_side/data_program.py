...
from data_publisher import IMU_dataPublisher
from data_subscriber import IMU_dataSubscriber
...
def main():
    ...
    if args.pub:
        print(f"Running IMU_dataPublisher on domain {args.domain}")
        IMU_dataPublisher.run_publisher(
            domain_id=args.domain,
            sample_count=args.sample_count)
    else:
        print(f"Running IMU_dataSubscriber on domain {args.domain}")
        IMU_dataSubscriber.run_subscriber(
            domain_id=args.domain,
            sample_count=args.sample_count)
